...
namespace VHSSyncSAPToWorkflow
{
    class Functions
    {
        ...
        public static DataTable ReadVBAKTable(RfcDestination prd , string CompanyCode)
        {
            ...
            try
            {
                ...
                tableInop.SetValue("Text", string.Format("VKORG = '{0}'", CompanyCode));
                                                       // (" VBELN = '{0}' and VKORG = '{1}'", strSalesOrder, strCompanyCode));
        ...
        public static DataTable ReadPRPSTable(RfcDestination prd )
        {
            string companycode = "4130";
            string ControllingArea = "4000";
            try
            {
        ...
        public static DataTable ReadStatusTable(RfcDestination prd, string OrderNumber ,string tableName)
        {
            //string companycode = "4130";
            //string ControllingArea = "4000";
            try
            {
                ...
                IRfcTable tableInop = BapiRFCReadTable.GetTable("OPTIONS");
                tableInop.Append();//添加一行
                tableInop.SetValue("Text", string.Format("PSPEL = '{0}'", OrderNumber));
        ...
        public static DataTable ReadAUFKTable(RfcDestination prd, string tableName ,int OrderType)
        {
            string companycode = "4130";
            //string ControllingArea = "4000";
            try
            {
                ...
                IRfcTable tableInop = BapiRFCReadTable.GetTable("OPTIONS");
                tableInop.Append();//添加一行
                tableInop.SetValue("Text", string.Format(" AUTYP EQ {0} and WERKS EQ '{1}'", OrderType, companycode)); //AUART = '{0}' and 
