    ...
    public class MyBackendConfig : IDestinationConfiguration
    {
        public RfcConfigParameters GetParameters(String destinationName)
        {
            ...
            if ("PRD_000".Equals(destinationName))
            {
                ...
                parms.Add(RfcConfigParameters.AppServerHost, "172.21.51.240");   //SAP主机IP  PP2 :172.21.51.240    HP1: 172.21.51.1    HQ1: 172.21.51.2   open-->cmd--->ping SAPPP2/SAPHP1/SAPHQ1--->get the IP
