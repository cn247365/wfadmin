...
namespace WebApp
{
  public static class SqlSugarFactory
  {
    public static ISqlSugarClient CreateSqlSugarClient()
    {
      ...
      {
        ConnectionString =ConfigurationManager.ConnectionStrings["wfdbConnection"].ConnectionString, //必填（连接字符串）
    ...
    public static ISqlSugarClient CreateLocalSqlSugarClient()
    {
      var db = new SqlSugarClient(new ConnectionConfig()
      {
